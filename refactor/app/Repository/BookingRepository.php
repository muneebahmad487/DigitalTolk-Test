...
class BookingRepository extends BaseRepository
{
    ...
    protected function getCustomerJobs(User $user)
    {
        ...
        return $this->categorizeJobs($jobs, $user);
    }

    protected function getTranslatorJobs(User $user)
    {
    ...
    protected function categorizeJobs($jobs, User $user)
    {
        $emergencyJobs = [];
        $normalJobs = [];
        ...
        return ['emergencyJobs' => $emergencyJobs, 'noramlJobs' => $noramlJobs, 'user' => $user, 'usertype' => $user->is('customer') ? 'customer' : 'translator'];
    }
    ...
    public function getUsersJobsHistory($user_id, Request $request)
    {
        ...
        if ($user->is('customer')) {
            return $this->getCustomerJobsHistory($user);
        } elseif ($user->is('translator')) {
            return $this->getTranslatorJobsHistory($user, $request);
        }

        return [];
    }

    protected function getCustomerJobsHistory(User $user)
    {
        $jobs = $user->jobs()
    ...
    protected function getTranslatorJobsHistory(User $user, Request $request)
    {
